...
if ($lastmodified && (time() - $lastmodified < 60 * 10)) {
	...
	foreach ($PokemonServers as &$server) {
		...
		if ($server['id'] === 'showdown') {
			$server['uri'] = $externProtocol . '//' . $routes['client'];
		} else {
...
<?php if (isset($_REQUEST['insecure'])) { ?>
					<a class="button greenbutton" href="http://<?= $routes['client'] ?>/?insecure">Play (insecure mode)</a>
<?php } else { ?>
					<a class="button greenbutton" href="<?= $externProtocol ?>//<?= $routes['client'] ?>/">Play online</a>
<?php } ?>
				</p>
				<p class="mainbutton" id="win-install" style="display:none;text-align:center;color:#777;margin:-10px 0 -0px 0">
					or<br /><a href="https://<?= $routes['root'] ?>/autodownload/win">Install <small>(Windows)</small></a>
				</p>
				<p class="mainbutton" id="mac-install" style="display:none;text-align:center;color:#777;margin:-10px 0 -0px 0">
					or<br /><a href="https://<?= $routes['root'] ?>/autodownload/mac">Install <small>(OS X)</small></a>
				</p>
