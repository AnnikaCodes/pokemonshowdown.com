...
?>
		<div class="main">
			...
			<blockquote><p>
				<img src="//<?= $routes['client'] ?>/sprites/categories/Physical.png" alt="[Physical]" /> Physical<br />
				<img src="//<?= $routes['client'] ?>/sprites/categories/Special.png" alt="[Special]" /> Special<br />
			</p></blockquote>
			<p>
			...
			<p class="mainbutton">
				<a class="button greenbutton" href="//<?= $routes['client'] ?>/">Play online</a>
			</p>
			<p>
